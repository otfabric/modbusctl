...
func ss(c config.ScanConfig) scanSettings {
	return scanSettings{ScanConfig: c}
}
...
func TestAllStrategies_EmptyRange(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s, err := newScanStrategy(ss(tt.cfg))
			if err != nil {
